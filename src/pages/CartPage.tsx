    ...
    <section className="cart-page">
      <div className="container cart-page__inner">
        <header className="cart-page__header">
          ...
          <h1>Your cart</h1>
          <p>{defaultCartItems.length} item{defaultCartItems.length !== 1 ? 's' : ''} ready for checkout.</p>
        </header>
        ...
        <div className="cart-layout">
          <section className="cart-items-panel">
            <div className="cart-items-toolbar">
              <h2>Items</h2>
              <button type="button">Remove unavailable</button>
            </div>
          ...
          <aside className="cart-summary-panel">
            ...
            <p className="cart-summary-note">Taxes calculated at checkout. Free shipping on orders over {formatPrice(50)}.</p>
