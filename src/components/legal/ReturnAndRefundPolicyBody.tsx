import {
  returnAndRefundPolicyIntro,
  returnAndRefundPolicySections,
  type ReturnAndRefundPolicyBlock,
} from '../../lib/returnAndRefundPolicyContent'
...
function PolicyBlock({ block }: { block: ReturnAndRefundPolicyBlock }) {
  if (block.kind === 'ul') {
    return (
